...
#include <memory>
#include "../../Classroom_Assistant/welcome.h"
...
QT_MOC_LITERAL(8, 14), // "login_register"
QT_MOC_LITERAL(23, 0) // ""

    },
    "Welcome\0login_register\0"
};
...
void Welcome::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->login_register(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Welcome::login_register)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Welcome, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
