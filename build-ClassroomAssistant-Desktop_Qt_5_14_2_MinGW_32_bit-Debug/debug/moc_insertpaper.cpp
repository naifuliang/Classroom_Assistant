...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_InsertPaper_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_InsertPaper_t qt_meta_stringdata_InsertPaper = {
    {
QT_MOC_LITERAL(0, 0, 11), // "InsertPaper"
QT_MOC_LITERAL(1, 12, 17), // "InsertPaperClosed"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 18) // "InsertPaperSucceed"
...
void InsertPaper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->InsertPaperSucceed(); break;
        default: ;
        }
        ...
        {
            using _t = void (InsertPaper::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InsertPaper::InsertPaperSucceed)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject InsertPaper::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_InsertPaper.data,
...
// SIGNAL 1
void InsertPaper::InsertPaperSucceed()
{
